...
public class Forgetcus extends HttpServlet 
{
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            PreparedStatement pst=con.prepareStatement("select Password from customer where Username=? and Email=?");
            ...
            RequestDispatcher rd=request.getRequestDispatcher("Forgetcus.html");
